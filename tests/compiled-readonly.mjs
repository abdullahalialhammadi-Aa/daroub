...
fs.writeFileSync(config,JSON.stringify({name:'daroub-readonly-verification',main:path.join(dist,'server',built.main),compatibility_date:built.compatibility_date,compatibility_flags:built.compatibility_flags,assets:{directory:path.join(dist,'client')},d1_databases:[{binding:'DB',database_name:'readonly-audit',database_id:'11111111-1111-4111-8111-111111111111'}],vars:{DAROUB_READ_ONLY:'true',DAROUB_CHATGPT_SITES:'true',DAROUB_OWNER_IDS:'owner-a',DAROUB_EDITOR_IDS:'editor-a'}},null,2));
